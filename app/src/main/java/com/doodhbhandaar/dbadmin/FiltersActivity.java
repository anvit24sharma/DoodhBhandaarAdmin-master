...
public class FiltersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noOfCoustmers=(TextView)findViewById(R.id.no_customers);
...
//                        updatingdata();
            ...
            public void onStatsClick(View view, int position) {
                Intent intent = new Intent(FiltersActivity.this,CustomerRecord.class);
                intent.putExtra("pk",customerDataArrayList.get(position).pk);
                intent.putExtra("name",customerDataArrayList.get(position).customerName);
    ...
    private void fetchDeliveryBoys() {
        ...
        deliveryBoyReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
               ...
               // noOfCoustmers.setText("Number of Customers : "+deliveryBoysNamesItems.size());
            }
    ...
    public void apply(View view) {
        ...
        noOfCoustmers.setVisibility(View.VISIBLE);
    ...
    private void refineCheckArea(CustomerData data) {
        ...
        noOfCoustmers.setText("Number of Customers : "+customerDataArrayList.size());
