...
public class CustomerProfileActivity extends AppCompatActivity  {
    ...
    EditText editTextName, editTextContact, editTextaddress, editTextQuantity,editTextCost;
...
private void fetchDeliveryBoys() {
    ...
    private void findViews() {
        ...
        editTextCost.setText(getIntent().getStringExtra("Cost"));
    ...
    private void registerCustomer() {
        ...
        customerData.Cost=editTextCost.getText().toString();
        ...
        customersReference.child(bundle.getString("pk")).child("Cost").setValue(customerData.Cost);
