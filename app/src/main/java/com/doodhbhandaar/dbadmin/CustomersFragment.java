...
public class CustomersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        no_customer=output.findViewById(R.id.no_customers);
    ...
    private void updatingdata() {
        ...
        customersReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                //Log.i("size1",customerDataArrayList.size()+" "+customerAdapter.getItemCount());
                pd.dismiss();
                no_customer.setText("Number of Customers : "+customerDataArrayList.size());
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
             ...
             //   Log.i("size2",customerDataArrayList.size()+" "+customerAdapter.getItemCount());
        ...
        CustomersInterface customersInterface = new CustomersInterface() {
            ...
            public void onViewClick(View view,int position) {
                ...
                intent.putExtra("longitude",customerDataArrayList.get(position).longitude);
                intent.putExtra("Cost",customerDataArrayList.get(position).Cost);
            ...
            public void onLongClick(View view, final int position) {
                ...
                builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        customerdataReference.child(customerDataArrayList.get(position).pk).removeValue();
            ...
            public void onStatsClick(View view, int position) {
                ...
                Intent intent = new Intent(getContext(),CustomerRecord.class);
                intent.putExtra("pk",customerDataArrayList.get(position).pk);
                intent.putExtra("name",customerDataArrayList.get(position).customerName);
        ...
        Log.i("size",customerDataArrayList.size()+" "+customerAdapter.getItemCount());
       // no_customer.setText("Number of Customers : "+customerDataArrayList.size());
